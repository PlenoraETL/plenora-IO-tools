...
Windows GDAL 3.10.3/OpenFileGDB sono implementati e hanno superato i rispettivi
  benchmark. Il pushdown OpenFileGDB è ora implementato tramite un fork
  governato di `gdal 0.17.1` e ha superato il benchmark A/B; KML e DXF restano
  subordinati ai prerequisiti e ai veti già registrati.
...
- Il catalogo espone capability di scrittura, concorrenza reader, projection e
  ...
  Shapefile `8/6` e FileGDB `10/8`, così il fingerprint distingue la nuova
