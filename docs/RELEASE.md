...
| ultima qualificata | `07c7874` |
| revisione misurata | `07c7874` |
| passi del checkpoint | 57 |
| passi verdi | 57 |
| passi omessi | 0 |
| passi falliti | 0 |
| input di replay | 46 351 |
| target di replay | 15 |
| crash di replay | 0 |
...
| copertura LCOV | 86,21% |
| righe coperte LCOV | 29 596 |
| righe strumentate LCOV | 34 329 |
| copertura cargo | 84,31% |
