...
| ultima qualificata | `973080c` |
| revisione misurata | `973080c` |
| passi del checkpoint | 67 |
| passi verdi | 67 |
| passi omessi | 0 |
| passi falliti | 0 |
| input di replay | 56 461 |
| target di replay | 15 |
| crash di replay | 0 |
...
| copertura LCOV | 87,40% |
| righe coperte LCOV | 33 869 |
| righe strumentate LCOV | 38 750 |
| copertura cargo | 85,68% |
